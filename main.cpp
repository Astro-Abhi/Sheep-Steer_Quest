...
int simMain(int argc, char* argv[])
{
    ...
    float maxSpeed = 10;
    float maxForce = 03;
    float flockSepWeight = 10;
    float flockAliWeight = 10;
    float flockCohWeight = 10;
    float collisionWeight = 5;
    float flockSepRadius = 10;
    float flockAliRadius = 10;
    float flockCohRadius = 10;
    float destWeight = 20;
